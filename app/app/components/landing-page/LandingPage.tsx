...
export default function LandingPage(){
    ...
    return (
        ...
        <div className="w-screen h-[2550px] relative bg-white">
            ...
            <div className="w-full h-[800px] top-[1700px] absolute">
                <div className="w-full h-[800px] left-0 top-0 absolute bg-black" />
                <div className="w-1/8 tablet:w-1/2 h-[74px] left-10 top-[106px] absolute text-white text-4xl font-normal font-['Inter']">Facial Blurring</div>
                <div className="w-1/2 md:w-3/4 tablet:w-1/2 md:w-1/4 left-10 top-[195px] absolute text-white text-2xl font-light font-['Inter']">Want to keep things private? Hide your face with our trademark, Anonymous Mode</div>
                <div className="hidden md:block w-[200px] h-[200px] tablet:w-[567px] tablet:h-[567px] ml-5 right-5 top-[250px] tablet:top-[121px] absolute bg-white" />
            </div>
